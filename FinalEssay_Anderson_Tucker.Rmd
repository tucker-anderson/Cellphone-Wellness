...
```{r echo=FALSE, results='hide', collapse=TRUE}
cols <- c('long', 'lat')
# note that a Google API key needs to be registered with register_google() before this function works
d$location = apply(d[, ..cols], 1, revgeocode)
```
```{r}
